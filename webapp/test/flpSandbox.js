		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#namespace1productsmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespace1productsmanager-display": {
								"semanticObject": "namespace1productsmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace1.productsmanager",
									"url": sap.ui.require.toUrl("namespace1/productsmanager")
								}
							}
						}
					}
